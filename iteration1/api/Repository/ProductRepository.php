...
class ProductRepository extends EntityRepository {
    ...
    public function save($product): bool {
        $requete = $this->cnx->prepare("INSERT INTO Product (name, price, description, volume, stock, category_id, image) VALUES (:name, :price, :description, :volume, :stock, :category_id, :image)");
    ...
    public function update($product): bool {
        $requete = $this->cnx->prepare("UPDATE Product SET name=:name, price=:price, description=:description, volume=:volume, stock=:stock, category_id=:category_id, image=:image WHERE id=:id");
        $id = $product->getId();
        $name = $product->getName();
        $price = $product->getPrice();
        $description = $product->getDescription();
